...
class Car:
    ...
    def __init__(self, year_prod, enginee, color, packet):
    ...
    def choose(self):
        return f'Choosen options: {self.year_prod}' \
               f'\n{self.enginee}' \
               f'\n{self.color}' \
               f'\n{self.packet}'
    ...
    @classmethod
    def commons(cls):
        return f'All cars are {cls.test} because of gravity'

    @staticmethod
    def spin(speed='2000 miles per hour'):
        return f'The planet spins and spins a {speed}'

option1 = Car(2018, 2.0, 'red', 'high')

print(option1.choose())
